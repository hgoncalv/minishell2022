...
SRCS 	= exec/builtin_utils.c exec/builtin.c exec/env_functions.c exec/exec_checkers.c exec/exec_cond.c exec/exec_utils.c exec/exec.c \
	...
	utils/string_functions.c utils/ft_isnum.c parse/update_line.c exec/redirections.c parse/redir.c parse/parsing_new.c parse/parsing_new_utils.c shell/signal.c exec/helper_exec.c\
